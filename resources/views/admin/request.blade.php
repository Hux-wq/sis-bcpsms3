<x-app-layout>
    ...
    <div class="container-fluid px-4 py-3">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #ffc107 0%,rgb(255, 174, 0) 100%);">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header  text-white py-3" style="background: linear-gradient(135deg, #28a745 0%,rgb(24, 219, 161) 100%);">
                <div class="d-flex align-items-center">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #dc3545 0%,rgb(218, 80, 64) 100%);">
                <div class="d-flex align-items-center">
